    ...
    return (
      <div className="max-w-4xl mx-auto p-6 text-center">
        <div className="bg-red-100 border border-red-400 text-red-700 px-6 py-8 rounded-lg">
          ...
          <button
            onClick={() => router.push('/surveys/respond')}
    ...
    return (
      <div className="max-w-4xl mx-auto p-6 text-center">
        <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-6 py-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">Survey Not Available</h2>
          <p className="mb-6">This survey is currently {survey.status} and not accepting responses.</p>
          <button
            onClick={() => router.push('/surveys/respond')}
